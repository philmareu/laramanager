...
@section('actions')
    <a href="{{ url('admin/' . $resource->slug . '/' . $entry->id) }}" class="uk-button uk-button-small uk-button-primary">Cancel</a>
@endsection
...
@section('default-content')
    ...
    <form action="{{ url('admin/' . $resource->slug . '/object/' . $entry->id . '/' . $object->pivot->id) }}" method="POST" class="uk-form uk-form-stacked">
