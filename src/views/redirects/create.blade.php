...
@section('content')
    ...
    <form action="{{ route('admin.redirects.store') }}" enctype="multipart/form-data" method="POST" class="uk-form uk-form-stacked">
        ...
        @include('laraform::elements.form.text', ['field' => ['name' => 'from']])
        @include('laraform::elements.form.text', ['field' => ['name' => 'to']])
        @include('laraform::elements.form.select', ['field' => ['name' => 'type', 'options' => ['301' => '301 Permanent', '302' => '302 Temporary']]])
