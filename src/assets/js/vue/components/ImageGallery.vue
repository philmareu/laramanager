    ...
    <div>
        ...
        <form-modal id="modal-image" :buttons="buttons" :status="status" v-on:submitted="processForm" v-on:closing="closeModal">
            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-1-2">
                    <input type="text" name="title" v-model="resource.title">
                    <input type="text" name="filename" v-model="resource.filename">
                    <input type="text" name="original_filename" v-model="resource.original_filename" disabled>
                    <input type="text" name="alt" v-model="resource.alt">
                    <textarea name="description" cols="30" rows="10" v-model="resource.description"></textarea>
                </div>
            </div>
        </form-modal>
    </div>
